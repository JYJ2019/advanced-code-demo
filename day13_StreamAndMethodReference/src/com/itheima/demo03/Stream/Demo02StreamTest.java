...
/**
 * @Description：练习:集合元素处理(Stream方式)
 * @Author 金宇佳
...
/*
    ...
    将上一题当中的传统for循环写法更换为 Stream 流式处理方式.
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        /*
            ...
            7. 打印整个队伍的Person对象信息。
         */
        Stream<String> concatStream = Stream.concat(oneStream, twoStream);
        // concatStream.map(name -> new Person(name)).forEach(System.out::println);
