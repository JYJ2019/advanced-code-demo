...
//        show03();
    ...
    private static void show03() {
        ...
        Integer i1 = map.get("杨颖");
        System.out.println("i1:" + i1);//i1:165

        Integer i2 = map.get("林志颖");
    ...
    private static void show02() {
        ...
        Integer i1 = map.remove("林志玲");
        System.out.println(i1);//178
        System.out.println(map);//{赵丽颖=168, 杨颖=165}

        Integer i2 = map.remove("林志颖");
//        int i2 = map.remove("林志颖");//自动拆箱 NullPointerException 空指针异常
    ...
    /*
        public V put(K key, V value): 把指定的键与指定的值添加到Map集合中.
            返回值:v
                ...
                存储键值对的时候,key重复,会使用性的value替换map中重复的value,返回被替换的value值
     */
    private static void show01() {
        ...
        System.out.println("put2:" + put2);//put2:范冰冰1
